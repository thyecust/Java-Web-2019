                ...
                <td><table width="100%"  border="0" cellspacing="0" cellpadding="0" class="tt">
                    ...
                    <tr id="managerTr">
                      <td  id="sub2" align="left" valign="middle" style="display:none;background-image:url(image/top_level_bg.gif);">
                        <div><a href="managerUser.jsp" target="main">用户管理</a></div>
                        <div><a href="addUser.jsp" target="main">用户添加</a></div></td>
                    </tr>
                    <tr id="managerTr">
                      <td id="parent1" height="30" align="left" valign="middle" style="background-image:url(image/Menutab.jpg); background-position-x:Left;" onClick="exit()"><a>&nbsp;&nbsp;&nbsp;&nbsp;退出系统</a></td>
                    </tr>
                </table></td>
              </tr>
          </table></td>
